...
sed -i "s/PROJECT_NAME/$PROJECT_NAME/g;s/AUTHOR/$AUTHOR/g;s/EMAIL/$EMAIL/g;s/VERSION/$VERSION/g;s/DESCRIPTION/$DESCRIPTION/g;s|URL|$URL|g;s/LICENSE/$LICENSE/g;" setup.py
echo "Done!"
...
sed -i "s/PROJECT_NAME/$PROJECT_NAME/g;s/AUTHOR/$AUTHOR/g;s/COPYRIGHT/$COPYRIGHT/g;s/RELEASE/$VERSION/g;s/SHORT_VERSION/$SHORT_VERSION/g;" docs/conf.py
